 ...
 * @Description :
 * @Author : ZGS
 * @Date: 2020-04-14 23:41
 */
public class MpGenerator2 {
    //数据库用户名密码
    private static String username = "root";
    private static String password = "Alias2011";

    //表前缀，不需要则写空
    private static String tablePrefix = "tb_";
    //数据库连接url
    private static String dbUrl = "jdbc:mysql://localhost:3306/grocery?useUnicode=true&useSSL=false&characterEncoding=utf8&serverTimezone=UTC&useJDBCCompliantTimezoneShift=true&useLegacyDatetimeCode=false";
